...
if(NOT NodeJS_INCLUDE_DIR OR NOT NodeJS_V8_INCLUDE_DIR OR NOT NodeJS_UV_INCLUDE_DIR)
	...
	message(STATUS "NodeJS_HEADERS_OUTPUT_PATH:${NodeJS_HEADERS_OUTPUT_PATH}")
	message(STATUS "NodeJS_HEADERS_OUTPUT_PATH:${NodeJS_HEADERS_OUTPUT_PATH}")
	message(STATUS "NodeJS_BASE_PATH:${NodeJS_BASE_PATH}")
	message(STATUS "NodeJS_DOWNLOAD_FILE:${NodeJS_DOWNLOAD_FILE}")
	message(STATUS "NodeJS_DOWNLOAD_URL:${NodeJS_DOWNLOAD_URL}")
	execute_process(COMMAND   ls -R ${NodeJS_HEADERS_OUTPUT_PATH})
endif()
...
if(NOT NodeJS_LIBRARY)
	...
	if(NOT NodeJS_LIBRARY)
		...
		message(STATUS "NodeJS_VERSION: ${NodeJS_VERSION}")
		message(STATUS "NodeJS_VERSION_MODULE: ${NodeJS_MODULE_VERSION}")
